...
outFileStem <- './twin_res/twin_univ_polyE_sexes_combined/'
...
Vars <- c("polyNSE_preschool_NSE_childhood_hyp_parent",
          "polyNSE_preschool_NSE_childhood_con_parent",
          "polyNSE_preschool_NSE_childhood_ep_parent",
          "polyNSE_preschool_NSE_childhood_pp_parent",
           "polyNSE_childhood_NSE_adolescence_hyp_parent",
           "polyNSE_childhood_NSE_adolescence_con_parent",
           "polyNSE_childhood_NSE_adolescence_ep_parent",
           "polyNSE_childhood_NSE_adolescence_pp_parent",
           "polyNSE_adolescence_NSE_adulthood_hyp_parent",
           "polyNSE_adolescence_NSE_adulthood_con_parent")
